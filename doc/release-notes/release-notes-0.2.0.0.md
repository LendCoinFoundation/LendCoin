LendCoin version 0.2.0.0 is now available from:

  https://github.com/LendCoinFoundation/LendCoin/releases
...
Please report bugs using the issue tracker at github:
  ...
  https://github.com/LendCoinFoundation/LendCoin/issues
...
or just copy over /Applications/LendCoin-Qt (on Mac) or LendCoind/LendCoin-qt (on Linux).
...
LendCoin data directory (listed below) and delete everything except the
wallet.dat and LendCoin.conf

Linux : ~/.LendCoin/

Windows : %appdata%\Roaming\LendCoin
...
- `62a3da1` Update GitHub URLs to point to LendCoinFoundation/LendCoin
...
- `19ca0ef` Point GitHub URL to LendCoinFoundation
